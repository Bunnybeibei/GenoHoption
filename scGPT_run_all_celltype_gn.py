...
temperature = 5. # GenoHoption-h
alpha = 0.25 # GenoHoption-p
params = ('both', True, 0, False)
iter_num = 6 # iteration
FRAC = 0.75 # sample rate

for diffusion_mode in [1]: # 0 is ppr while 1 is heat
    for SEED in [0,1,2,3,4]:
        for DATASET_NAME in ['ms', 'pancreas', 'myeloid']: # ['ms',''myeloid']
            ...
            run = wandb.init(
                ...
                project=f"Cell Annotation",
                name=f'{SEED}_{FRAC}_{DATASET_NAME}',
                group=DATASET_NAME,
                reinit=True,
            ...
            # if co-expression has not been created
            ...
            print("best epoch: ", best_model_epoch)

            ## Step 5: Inference with fine-tuned

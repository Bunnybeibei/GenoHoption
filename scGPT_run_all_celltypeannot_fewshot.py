...
res_file_path = 'finetune_results.txt'
with open(res_file_path, 'a') as file:
    file.write("dataset_name\tfraction\tseed\tbest_epoch\taccuracy\tprecision\trecall\tmacro_f1\n")
    ...
    for FRAC in [0.75]:
        for SEED in [0,1,2,3,4]:
            ...
            if config.load_model is not None:
                ...
                model_config_file = model_dir / "args_new.json"
                model_file = model_dir / "best_model_new.pt"
                vocab_file = model_dir / "vocab_new.json"
            ...
            ################## update #################
            import random
            selected_nums = random.sample(range(0, 15), 7)
            ...
            with open(res_file_path, 'a') as file:
                file.write(f"{dataset_name}\t{fraction}\t{SEED}\t{best_model_epoch}\t{results['test/accuracy']}\t{results['test/precision']}\t{results['test/recall']}\t{results['test/macro_f1']}\n")